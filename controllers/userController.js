...
export const register = catchAsyncError(async (req, res, next) => {
  ...
  // Prevent using name or email in password
  const lowerPassword = password.toLowerCase();
  if (
    lowerPassword.includes(name.toLowerCase()) ||
  ...
  //  Determine role: default 'user', or admin if matches ADMIN_EMAIL
  let role = "user";
  ...
  // Send token (cookies + access token)
